# Generated by Django 4.0.4 on 2022-06-26 02:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='casys.order')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username_info_Receive', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='casys.client')),
            ],
        ),
        migrations.AddField(
            model_name='order',
